...
for line in inFile:
  ...
  if line[0] != '#':
    ...
    if data[2] == "CDS":
      ...
      data[-1] = 'gene_id "'+gene_id+'"; gene_version"'+gene_version+'"; transcript_id "'+transcript_id+'"; transcript_version "'+transcript_version+'"; exon_number "'+exon_number+'"; protein_id"'+protein_id
      #This is a Brachy only hack, will have to regex it later. Changing only to chromosome number except for the supers.
      if data[0][:2] == "Bd":
        data[0] = data[0][-1]
